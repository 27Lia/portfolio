...
const Introduction: React.FC = () => {
  return (
    <>
      ...
      <DataContainer>
        <Img src="../img.jpe" alt="프로필 이미지"></Img>
      ...
      <Text>
        <strong>아이디어</strong>를 내고 <strong>적극적으로 소통</strong>하는
        것을 좋아합니다. 반복적인 작업을 지속하는것을 지양하며 효율적인 작업을
        지향합니다.
      </Text>

      <Text>
        이전 직장에서 업무를 수행하면서 <strong>반복적인 작업에 직면</strong>
        하게 되었고,
        <strong>더 효율적인 방법이 없을까?</strong> 하는 호기심으로 인해 개발을
        시작하게 되었습니다.
      </Text>
    </>
  );
